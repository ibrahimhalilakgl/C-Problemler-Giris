...
<div class="container" style="max-width: 800px; margin: auto; background: #fff; padding: 20px; box-shadow: 0 0 10px rgba(0,0,0,0.1);">
 ...
 <h2 style="color: #555;">📑 Problemler</h2>
    <ul style="list-style-type: none; padding: 0;">
        ...
        <li style="background: #e2e2e2; margin: 5px 0; padding: 10px; border-radius: 5px;"><a href="#fiyat-ve-kdv-oranı-girilen-ürünün-toplam-fiyatını-hesaplama" style="text-decoration: none; color: #333; font-weight: bold;">Fiyat ve KDV Oranı Girilen Ürünün Toplam Fiyatını Hesaplama</a></li>
        <li style="background: #e2e2e2; margin: 5px 0; padding: 10px; border-radius: 5px;"><a href="#verilen-3-sayının-ortalamasını-bulma" style="text-decoration: none; color: #333; font-weight: bold;">Verilen 3 Sayının Ortalamasını Bulma</a></li>
        <li style="background: #e2e2e2; margin: 5px 0; padding: 10px; border-radius: 5px;"><a href="#girilen-gün-sayısını-yıl-hafta-ve-gün’e-çevirme" style="text-decoration: none; color: #333; font-weight: bold;">Girilen Gün Sayısını Yıl, Hafta ve Gün’e Çevirme</a></li>
        <li style="background: #e2e2e2; margin: 5px 0; padding: 10px; border-radius: 5px;"><a href="#üç-sayının-toplamını-2-değişken-kullanarak-hesaplama" style="text-decoration: none; color: #333; font-weight: bold;">Üç Sayının Toplamını 2 Değişken Kullanarak Hesaplama</a></li>
        <li style="background: #e2e2e2; margin: 5px 0; padding: 10px; border-radius: 5px;"><a href="#a-ve-b-değişkenlerinin-değerlerini-yer-değiştirme" style="text-decoration: none; color: #333; font-weight: bold;">A ve B Değişkenlerinin Değerlerini Yer Değiştirme</a></li>
    </ul>
